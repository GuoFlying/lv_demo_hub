 ...
 *********************/
#include "../app.h"
#define APP_STRESS_TIME_STEP 50
...
lv_obj_t *app_stress(void)
{
    ...
    g_timer1 = lv_timer_create(obj_test_task_cb, APP_STRESS_TIME_STEP, NULL);
...
static void obj_test_task_cb(lv_timer_t *tmr)
{
    ...
    case 0:
        ...
        main_page = lv_obj_create(g_parent);
    ...
    case 1:
    {
        obj = lv_tabview_create(g_parent, LV_DIR_TOP, 50);
        ...
        auto_del(obj, APP_STRESS_TIME_STEP * 5 + 30);
    }
    break;
    ...
    case 2:
        ...
        lv_anim_set_time(&a, APP_STRESS_TIME_STEP * 2);
        lv_anim_set_exec_cb(&a, set_width_anim);
        lv_anim_set_values(&a, 100, 200);
        lv_anim_set_playback_time(&a, APP_STRESS_TIME_STEP * 2);
        lv_anim_set_repeat_count(&a, LV_ANIM_REPEAT_INFINITE);
        lv_anim_start(&a);

        /*Delete the object a few sec later*/
        auto_del(obj, APP_STRESS_TIME_STEP * 10);
    ...
    case 3:
        ta = lv_textarea_create(g_parent);
    ...
    case 7:
        ...
        auto_del(obj, APP_STRESS_TIME_STEP * 2 + 70);

        obj = lv_slider_create(main_page);
        lv_obj_set_style_anim_time(obj, APP_STRESS_TIME_STEP * 8, 0);
        lv_slider_set_value(obj, 5000, LV_ANIM_ON); /*Animate to out of range value*/
        auto_del(obj, APP_STRESS_TIME_STEP * 5 + 22);
    ...
    case 11:
        ...
        auto_del(obj, APP_STRESS_TIME_STEP * 3 + 11);
        break;
    ...
    case 12:
        ...
        auto_del(obj, APP_STRESS_TIME_STEP * 20 + 22);
        break;
    ...
    case 13:
        ...
        lv_anim_set_time(&a, APP_STRESS_TIME_STEP * 2);
        lv_anim_set_delay(&a, APP_STRESS_TIME_STEP + 25);
        lv_anim_set_playback_time(&a, APP_STRESS_TIME_STEP * 5);
        ...
        auto_del(obj, APP_STRESS_TIME_STEP * 6 + 30);
        break;

    case 14:
        obj = lv_msgbox_create(NULL, "Title", "Some text on the message box with average length", mbox_btns, true);

        lv_timer_t *msgbox_tmr = lv_timer_create(msgbox_del, APP_STRESS_TIME_STEP * 5 + 30, obj);
    ...
    case 16:
    {
        lv_obj_t *tv = lv_tileview_create(g_parent);
        lv_obj_set_size(tv, 200, 200);
        auto_del(tv, APP_STRESS_TIME_STEP * 4 + 5);
    ...
    case 22:
        ...
        lv_spinbox_increment(obj);
        lv_spinbox_increment(obj);
        auto_del(obj, APP_STRESS_TIME_STEP * 2 + 15);
    ...
    case 23:
        obj = lv_chart_create(main_page);
        {
            ...
            auto_del(obj, APP_STRESS_TIME_STEP * 3);
        }
    ...
    case 24:
        ...
        auto_del(obj, APP_STRESS_TIME_STEP * 2 + 20);
        ...
        auto_del(obj, APP_STRESS_TIME_STEP * 1 + 60);
