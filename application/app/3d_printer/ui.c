...
void ui_Screen_1_Print_screen_init(void)
{
    ...
    lv_obj_set_align(ui_Background, LV_ALIGN_TOP_LEFT);
    ...
    lv_obj_align(ui_Label_Header, LV_ALIGN_LEFT_MID, 130, 0);
    ...
    lv_obj_align_to(ui_BTN_Menu_Move_S1, ui_BTN_Menu_Print_S1, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0);
    ...
    lv_obj_align_to(ui_BTN_Menu_Setting_S1, ui_BTN_Menu_Move_S1, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0);
    ...
    lv_obj_align(ui_S1_Content_Panel, LV_ALIGN_TOP_LEFT, 100, 60);
    ...
    if (lv_slider_get_mode(ui_Slider_Print_View) == LV_SLIDER_MODE_RANGE)
        lv_slider_set_left_value(ui_Slider_Print_View, 0,
                                 LV_ANIM_OFF);
...
void ui_Screen_2_Move_screen_init(void)
{
    ...
    lv_obj_set_align(ui_Background1, LV_ALIGN_TOP_LEFT);
    ...
    lv_obj_align(ui_Label_Header1, LV_ALIGN_LEFT_MID, 130, 0);
    ...
    lv_obj_align_to(ui_BTN_Menu_Move_S2, ui_BTN_Menu_Print_S2, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0);
    ...
    lv_obj_align_to(ui_BTN_Menu_Setting_S2, ui_BTN_Menu_Move_S2, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0);
    ...
    lv_obj_align(ui_S1_Content_Panel1, LV_ALIGN_TOP_LEFT, 100, 60);
...
void ui_Screen_3_Setting_screen_init(void)
{
    ...
    lv_obj_set_align(ui_Background2, LV_ALIGN_TOP_LEFT);
    ...
    lv_obj_align(ui_Label_Header2, LV_ALIGN_LEFT_MID, 130, 0);
    ...
    lv_obj_align_to(ui_BTN_Menu_Move_S3, ui_BTN_Menu_Move_S3, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0);
    ...
    lv_obj_align_to(ui_BTN_Menu_Setting_S3, ui_BTN_Menu_Move_S3, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0);
    ...
    lv_obj_align(ui_S1_Content_Panel2, LV_ALIGN_TOP_LEFT, 100, 60);
    ...
    if (lv_slider_get_mode(ui_Slider_Print_Speed) == LV_SLIDER_MODE_RANGE)
        lv_slider_set_left_value(ui_Slider_Print_Speed, 0,
                                 LV_ANIM_OFF);
    ...
    lv_obj_align(ui_Swich_Group, LV_ALIGN_TOP_LEFT, 620, 60);
