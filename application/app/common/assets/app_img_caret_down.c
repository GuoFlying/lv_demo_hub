/*
 * @Author: Flying
 * @Date: 2022-05-01 18:48:20
 * @LastEditors: Flying
 * @LastEditTime: 2022-05-01 18:48:40
 * @Description: 新建文件
 */
#include "../../app.h"
...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_CARET_DOWN uint8_t app_img_caret_down_map[] = {
...
const lv_img_dsc_t app_img_caret_down = {
  .header.always_zero = 0,
  .header.w = 13,
  .header.h = 8,
  .data_size = 104 * LV_IMG_PX_SIZE_ALPHA_BYTE,
  .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,
  .data = app_img_caret_down_map,
};
