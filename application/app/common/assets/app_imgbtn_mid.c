...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMGBTN_MID uint8_t app_imgbtn_mid_map[] = {
...
const lv_img_dsc_t app_imgbtn_mid = {
  .header.always_zero = 0,
  .header.w = 5,
  .header.h = 49,
  .data_size = 245 * LV_IMG_PX_SIZE_ALPHA_BYTE,
  .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,
  .data = app_imgbtn_mid_map,
};
