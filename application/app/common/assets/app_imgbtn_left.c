/*
 * @Author: Flying
 * @Date: 2022-05-01 18:36:22
 * @LastEditors: Flying
 * @LastEditTime: 2022-05-01 18:36:22
 * @Description: 新建文件
 */
#include "../../app.h"
...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMGBTN_LEFT uint8_t app_imgbtn_left_map[] = {
...
const lv_img_dsc_t app_imgbtn_left = {
  .header.always_zero = 0,
  .header.w = 8,
  .header.h = 50,
  .data_size = 400 * LV_IMG_PX_SIZE_ALPHA_BYTE,
  .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,
  .data = app_imgbtn_left_map,
};
