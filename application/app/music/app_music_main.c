 ...
 *      INCLUDES
 *********************/
#include "app_music_main.h"

#include "app_music_list.h"
#include "assets/app_spectrum_1.h"
#include "assets/app_spectrum_2.h"
#include "assets/app_spectrum_3.h"
...
static lv_timer_t *first_timer = NULL;
...
lv_obj_t *_app_music_main_create(lv_obj_t *parent)
{
    ...
    static lv_coord_t grid_rows[] = {APP_MUSIC_HANDLE_SIZE, /*Spacing*/
    ...
    static const lv_coord_t grid_cols[] = {LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
    static const lv_coord_t grid_rows[] = { APP_MUSIC_HANDLE_SIZE, /*Spacing*/
                                            LV_GRID_FR(1),         /*Spacer*/
                                            LV_GRID_CONTENT,       /*Title box*/
                                            LV_GRID_FR(3),         /*Spacer*/
                                            LV_GRID_CONTENT,       /*Icon box*/
    ...
    first_timer = lv_timer_create(stop_start_anim, INTRO_TIME + 6000, NULL);
    lv_timer_set_repeat_count(first_timer, 1);
    ...
    LV_IMG_DECLARE(app_img_lv_demo_music_logo);
    lv_obj_t *logo = lv_img_create(parent);
    lv_img_set_src(logo, &app_img_lv_demo_music_logo);
...
void _app_music_resume(void)
{
    ...
    lv_slider_set_range(slider_obj, 0, _app_music_get_track_length(track_id));
...
static void create_wave_images(lv_obj_t *parent)
{
    LV_IMG_DECLARE(app_img_lv_demo_music_wave_top);
    LV_IMG_DECLARE(app_img_lv_demo_music_wave_bottom);
    lv_obj_t *wave_top = lv_img_create(parent);
    lv_img_set_src(wave_top, &app_img_lv_demo_music_wave_top);
    ...
    lv_img_set_src(wave_bottom, &app_img_lv_demo_music_wave_bottom);
    ...
    LV_IMG_DECLARE(app_img_lv_demo_music_corner_left);
    LV_IMG_DECLARE(app_img_lv_demo_music_corner_right);
    lv_obj_t *wave_corner = lv_img_create(parent);
    lv_img_set_src(wave_corner, &app_img_lv_demo_music_corner_left);
    ...
    lv_img_set_src(wave_corner, &app_img_lv_demo_music_corner_right);
#if APP_MUSIC_ROUND == 0
...
static lv_obj_t *create_title_box(lv_obj_t *parent)
{
    ...
    lv_label_set_text(title_label, _app_music_get_title(track_id));
    ...
    lv_label_set_text(artist_label, _app_music_get_artist(track_id));
    ...
    lv_label_set_text(genre_label, _app_music_get_genre(track_id));
...
static lv_obj_t *create_icon_box(lv_obj_t *parent)
{
    ...
    lv_obj_t *icon;
    LV_IMG_DECLARE(app_img_lv_demo_music_icon_1);
    LV_IMG_DECLARE(app_img_lv_demo_music_icon_2);
    LV_IMG_DECLARE(app_img_lv_demo_music_icon_3);
    LV_IMG_DECLARE(app_img_lv_demo_music_icon_4);
    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_icon_1);
    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_icon_2);
    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_icon_3);
    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_icon_4);
...
static lv_obj_t *create_ctrl_box(lv_obj_t *parent)
{
    ...
    LV_IMG_DECLARE(app_img_lv_demo_music_btn_loop);
    LV_IMG_DECLARE(app_img_lv_demo_music_btn_rnd);
    LV_IMG_DECLARE(app_img_lv_demo_music_btn_next);
    LV_IMG_DECLARE(app_img_lv_demo_music_btn_prev);
    LV_IMG_DECLARE(app_img_lv_demo_music_btn_play);
    LV_IMG_DECLARE(app_img_lv_demo_music_btn_pause);

    lv_obj_t *icon;
    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_btn_rnd);
    lv_obj_set_grid_cell(icon, LV_GRID_ALIGN_START, 1, 1, LV_GRID_ALIGN_CENTER, 0, 1);

    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_btn_loop);
    lv_obj_set_grid_cell(icon, LV_GRID_ALIGN_END, 5, 1, LV_GRID_ALIGN_CENTER, 0, 1);

    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_btn_prev);
    ...
    lv_imgbtn_set_src(play_obj, LV_IMGBTN_STATE_RELEASED, NULL, &app_img_lv_demo_music_btn_play, NULL);
    lv_imgbtn_set_src(play_obj, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &app_img_lv_demo_music_btn_pause, NULL);
    ...
    lv_obj_set_width(play_obj, app_img_lv_demo_music_btn_play.header.w);

    icon = lv_img_create(cont);
    lv_img_set_src(icon, &app_img_lv_demo_music_btn_next);
    ...
    LV_IMG_DECLARE(app_img_lv_demo_music_slider_knob);
    ...
    lv_obj_set_style_bg_img_src(slider_obj, &app_img_lv_demo_music_slider_knob, LV_PART_KNOB);
...
static void track_load(uint32_t id)
{
    ...
    _app_music_list_btn_check(track_id, false);

    track_id = id;

    _app_music_list_btn_check(id, true);
...
static lv_obj_t *album_img_create(lv_obj_t *parent)
{
    LV_IMG_DECLARE(app_img_lv_demo_music_cover_1);
    LV_IMG_DECLARE(app_img_lv_demo_music_cover_2);
    LV_IMG_DECLARE(app_img_lv_demo_music_cover_3);
    ...
    {
    case 2:
        lv_img_set_src(img, &app_img_lv_demo_music_cover_3);
        spectrum = app_spectrum_3;
        spectrum_len = sizeof(app_spectrum_3) / sizeof(app_spectrum_3[0]);
        break;
    case 1:
        lv_img_set_src(img, &app_img_lv_demo_music_cover_2);
        spectrum = app_spectrum_2;
        spectrum_len = sizeof(app_spectrum_2) / sizeof(app_spectrum_2[0]);
        break;
    case 0:
        lv_img_set_src(img, &app_img_lv_demo_music_cover_1);
        spectrum = app_spectrum_1;
        spectrum_len = sizeof(app_spectrum_1) / sizeof(app_spectrum_1[0]);
        break;
    }
...
static void album_gesture_event_cb(lv_event_t *e)
{
    ...
    if (dir == LV_DIR_LEFT)
        _app_music_album_next(true);
    if (dir == LV_DIR_RIGHT)
        _app_music_album_next(false);
}
