...
LV_IMG_DECLARE(app_img_benchmark_cogwheel_argb);
LV_IMG_DECLARE(app_img_benchmark_cogwheel_rgb);
LV_IMG_DECLARE(app_img_benchmark_cogwheel_chroma_keyed);
LV_IMG_DECLARE(app_img_benchmark_cogwheel_indexed16);
LV_IMG_DECLARE(app_img_benchmark_cogwheel_alpha16);

LV_FONT_DECLARE(app_lv_font_benchmark_montserrat_12_compr_az);
LV_FONT_DECLARE(app_lv_font_benchmark_montserrat_16_compr_az);
LV_FONT_DECLARE(app_lv_font_benchmark_montserrat_28_compr_az);
...
static void img_rgb_cb(void)
{
    ...
    img_create(&style_common, &app_img_benchmark_cogwheel_rgb, false, false, false);
}
...
static void img_argb_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_argb, false, false, false);
}
...
static void img_ckey_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_chroma_keyed, false, false, false);
}
...
static void img_index_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_indexed16, false, false, false);
}
...
static void img_alpha_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_alpha16, false, false, false);
}
...
static void img_rgb_rot_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_rgb, true, false, false);
}
...
static void img_rgb_rot_aa_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_rgb, true, false, true);
}
...
static void img_argb_rot_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_argb, true, false, false);
}
...
static void img_argb_rot_aa_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_argb, true, false, true);
}
...
static void img_rgb_zoom_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_rgb, false, true, false);
}
...
static void img_rgb_zoom_aa_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_rgb, false, true, true);
}
...
static void img_argb_zoom_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_argb, false, true, false);
}
...
static void img_argb_zoom_aa_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    img_create(&style_common, &app_img_benchmark_cogwheel_argb, false, true, true);
}
...
{
    lv_style_reset(&style_common);
    lv_style_set_text_font(&style_common, &app_lv_font_benchmark_montserrat_12_compr_az);
    lv_style_set_text_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    txt_create(&style_common);
}
...
{
    lv_style_reset(&style_common);
    lv_style_set_text_font(&style_common, &app_lv_font_benchmark_montserrat_16_compr_az);
    lv_style_set_text_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    txt_create(&style_common);
}
...
{
    lv_style_reset(&style_common);
    lv_style_set_text_font(&style_common, &app_lv_font_benchmark_montserrat_28_compr_az);
    lv_style_set_text_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
    txt_create(&style_common);
}
...
lv_obj_t *app_benchmark(void)
{
    g_parent = lv_obj_create(NULL);
    lv_obj_add_event_cb(g_parent, parent_del_cb, LV_EVENT_DELETE, NULL);
...
static void generate_report(void)
{
    ...
    lv_obj_clean(g_parent);
    scene_bg = NULL;

    lv_obj_set_flex_flow(g_parent, LV_FLEX_FLOW_COLUMN);

    title = lv_label_create(g_parent);
    lv_label_set_text_fmt(title, "Weighted FPS: %" LV_PRIu32, fps_weighted);

    subtitle = lv_label_create(g_parent);
    lv_label_set_text_fmt(subtitle, "Opa. speed: %" LV_PRIu32 "%%", opa_speed_pct);

    lv_coord_t w = lv_obj_get_content_width(g_parent);
    lv_obj_t *table = lv_table_create(g_parent);
...
// static void app_benchmark_run_scene(int_fast16_t scene_no)
// {
//     benchmark_init();
...
static void scene_next_task_cb(lv_timer_t *timer)
{
    ...
    if (scenes[scene_act].create_cb)
    {
        ...
        rnd_reset();
        scenes[scene_act].create_cb();
        g_timer1 = lv_timer_create(scene_next_task_cb, SCENE_TIME, NULL);
        lv_timer_set_repeat_count(g_timer1, 1);
    }
    /*Ready*/
    else
    {
