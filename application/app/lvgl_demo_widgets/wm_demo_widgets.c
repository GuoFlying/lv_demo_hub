...
lv_obj_t *wm_demo_widgets()
{
    ...
    tv = lv_tabview_create(g_parent, LV_DIR_TOP, tab_h);

    lv_obj_set_style_text_font(g_parent, font_normal, 0);
    ...
    if (disp_size == DISP_LARGE)
    {
        ...
        LV_IMG_DECLARE(wm_img_lvgl_logo);
        lv_img_set_src(logo, &wm_img_lvgl_logo);
...
static void profile_create(lv_obj_t *parent)
{
    ...
    LV_IMG_DECLARE(wm_img_demo_widgets_avatar);
    lv_obj_t *avatar = lv_img_create(panel1);
    lv_img_set_src(avatar, &wm_img_demo_widgets_avatar);
    ...
    /*Create a keyboard*/
    lv_obj_t *kb = lv_keyboard_create(g_parent);
...
static void analytics_create(lv_obj_t *parent)
{
    ...
    g_timer1 = lv_timer_create(meter2_timer_cb, 100, meter2_indic);
...
void shop_create(lv_obj_t *parent)
{
    ...
    LV_IMG_DECLARE(wm_img_clothes);
    create_shop_item(list, &wm_img_clothes, "Blue jeans", "Clothes", "$722");
    create_shop_item(list, &wm_img_clothes, "Blue jeans", "Clothes", "$411");
    create_shop_item(list, &wm_img_clothes, "Blue jeans", "Clothes", "$917");
    create_shop_item(list, &wm_img_clothes, "Blue jeans", "Clothes", "$64");
    create_shop_item(list, &wm_img_clothes, "Blue jeans", "Clothes", "$805");
